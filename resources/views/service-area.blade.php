...
<head>
    ...
    <meta name="description" content="Ride Aide LLC serves the greater Seattle area including Seattle, Bellevue, Redmond, Kirkland, Renton, Federal Way, and surrounding communities. Check if we serve your location.">
...
<body class="bg-gray-50">
 ...
 <x-nav-layout />
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl">
                ...
                <p class="text-xl mb-8 opacity-90">
                    Ride Aide LLC provides comprehensive ADA-compliant transportation services throughout the Seattle metropolitan area and surrounding communities.
                </p>
                <div class="flex flex-wrap gap-3 mb-6">
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Seattle</span>
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Bellevue</span>
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Redmond</span>
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Kirkland</span>
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Renton</span>
                    <span class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">Federal Way</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <div class="zip-search-box p-8 max-w-3xl mx-auto -mt-16 relative z-10">
                <h2 class="font-heading text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">Check If We Serve Your Area</h2>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <div class="flex-1">
                            <input 
                                type="text" 
                                id="zipCodeInput" 
                                placeholder="Enter your ZIP code (e.g., 98101)" 
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="area-detail-card p-8">
                    <div class="mb-6">
                        <div class="w-16 h-16 bg-gray-100 text-gray-700 rounded-full flex items-center justify-center mx-auto mb-4">
                            <i class="fas fa-map-marker-alt text-2xl"></i>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="coverage-zone extended">
                            <h4 class="font-bold text-gray-800 mb-1">Response Time</h4>
                            <p class="text-gray-600 text-sm">Longer response time, schedule in advance for best service</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-gray-800 mb-4">Cities & Neighborhoods We Serve</h2>
                <div class="section-divider mb-4"></div>
                <p class="text-gray-600 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8">
                    <div class="flex items-center mb-6">
                        <div class="bg-blue-100 text-blue-700 w-12 h-12 rounded-lg flex items-center justify-center mr-4">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8">
                    <div class="flex items-center mb-6">
                        <div class="bg-teal-100 text-teal-700 w-12 h-12 rounded-lg flex items-center justify-center mr-4">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8">
                    <div class="flex items-center mb-6">
                        <div class="bg-gray-100 text-gray-700 w-12 h-12 rounded-lg flex items-center justify-center mr-4">
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-gray-800 mb-4">Medical Facilities We Serve</h2>
                <div class="section-divider mb-4"></div>
                <p class="text-gray-600 max-w-2xl mx-auto">
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-xl p-8">
                ...
                <p class="text-gray-600 text-center mb-6">
                    We provide regular transportation to dialysis centers, cancer treatment facilities, physical therapy clinics, and specialized medical appointments throughout our service area.
                </p>
                <div class="flex flex-wrap justify-center gap-3">
                    <span class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Davita Dialysis Centers</span>
                    <span class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Seattle Cancer Care Alliance</span>
                    <span class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Polyclinic Facilities</span>
                    <span class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Rehabilitation Centers</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="font-heading text-3xl md:text-4xl font-bold text-gray-800 mb-6">Scheduling in Your Area</h2>
                    <div class="section-divider mb-6 ml-0"></div>
                    
                    <div class="space-y-6 mb-8">
                        <div class="flex items-start">
                            <div class="bg-green-100 text-green-700 w-10 h-10 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                <i class="fas fa-check"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-800 mb-1">Advance Booking Recommended</h4>
                                <p class="text-gray-600">For best availability, book 24-48 hours in advance. Same-day bookings accepted based on availability.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">For extended service areas, we recommend booking 3-7 days in advance to ensure vehicle availability.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Set up regular weekly or monthly transportation for consistent needs like medical appointments or work commutes.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div class="space-y-6">
                            <div class="border-l-4 border-blue-500 pl-4 py-2">
                                ...
                                <p class="text-gray-600 text-sm">Our team can quickly check if we serve your specific location.</p>
                            ...
                            <div class="border-l-4 border-teal-500 pl-4 py-2">
                                ...
                                <p class="text-gray-600 text-sm">Send us your address and we'll confirm service availability.</p>
                                <a href="mailto:info@rideaidellc.com" class="text-blue-700 font-semibold hover:text-blue-800">
                            ...
                            <div class="border-l-4 border-orange-500 pl-4 py-2">
                                ...
                                <p class="text-gray-600 text-sm">Need service outside our regular areas? Contact us for special arrangements.</p>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <p class="text-gray-600 text-sm">
                                We're continuously expanding our service areas. If we don't currently serve your location, let us know! We use customer requests to prioritize new service area expansions.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-12 bg-blue-700 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Whether you're in downtown Seattle or the surrounding communities, Ride Aide is here to provide reliable, accessible transportation.
            </p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="tel:+12065551234" class="bg-white text-blue-700 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors">
                    <i class="fas fa-phone-alt mr-2"></i> Call Dispatch: (206) 555-1234
                </a>
            </div>
            <p class="mt-6 text-blue-200">
                <i class="fas fa-info-circle mr-2"></i> Questions about service in your specific area? Our team is happy to help.
            </p>
        </div>
    </section>
    ...
    <script>
        ...
        function initMap() {
            ...
            const cities = [
                { name: 'Seattle', coords: [47.6062, -122.3321], type: 'primary' },
                { name: 'Bellevue', coords: [47.6132, -122.2010], type: 'primary' },
                { name: 'Redmond', coords: [47.6740, -122.1215], type: 'primary' },
                { name: 'Kirkland', coords: [47.6815, -122.2087], type: 'secondary' },
                { name: 'Renton', coords: [47.4829, -122.2171], type: 'secondary' },
                { name: 'Federal Way', coords: [47.3139, -122.3393], type: 'secondary' },
                { name: 'Shoreline', coords: [47.7563, -122.3415], type: 'secondary' },
                { name: 'Bothell', coords: [47.7597, -122.1919], type: 'extended' },
                { name: 'Kent', coords: [47.3809, -122.2348], type: 'extended' },
                { name: 'Auburn', coords: [47.3073, -122.2285], type: 'extended' },
            ];
            
            cities.forEach(city => {
                let markerColor;
                switch(city.type) {
                    case 'primary': markerColor = '#1e40af'; break;
                    case 'secondary': markerColor = '#0d9488'; break;
                    case 'extended': markerColor = '#6b7280'; break;
                }
                ...
                marker.bindPopup(`<b>${city.name}</b><br>${city.type.charAt(0).toUpperCase() + city.type.slice(1)} Service Zone`);
            });
            
            // Add medical facility markers
            const medicalFacilities = [
                { name: 'UW Medical Center', coords: [47.6499, -122.3040] },
                { name: 'Swedish First Hill', coords: [47.6092, -122.3210] },
                { name: 'Virginia Mason', coords: [47.6095, -122.3330] },
                { name: 'Overlake Medical', coords: [47.6275, -122.1713] },
                { name: 'EvergreenHealth', coords: [47.7173, -122.1767] },
            ];
