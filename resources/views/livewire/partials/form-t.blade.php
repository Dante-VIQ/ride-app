<div x-data="{ showForm: false }" class="testimonials-container">
    ...
    <div x-show="showForm" x-cloak x-transition class="mb-10">
        <form wire:submit.prevent="create" class="space-y-4 bg-white p-6 rounded shadow-md max-w-2xl mx-auto">
            ...
            <!-- Content -->
            <div>
                <textarea wire:model="content" placeholder="Your Testimonial"
                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        <div class="group relative">
                            <button type="button" wire:click="$set('rating', {{ $i }})"
                                ...
                                <svg class="w-8 h-8 cursor-pointer transition-transform transform hover:scale-110 {{ $i <= ($rating ?? 0) ? 'text-yellow-400' : 'text-gray-300' }}"
                                    ...
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.175 3.616a1 1 0 00.95.69h3.801c.969 0 1.371 1.24.588 1.81l-3.073 2.234a1 1 0 00-.364 1.118l1.175 3.616c.3.921-.755 1.688-1.54 1.118l-3.073-2.234a1 1 0 00-1.175 0l-3.073 2.234c-.784.57-1.838-.197-1.539-1.118l1.175-3.616a1 1 0 00-.364-1.118L2.136 9.043c-.783-.57-.38-1.81.588-1.81h3.801a1 1 0 00.95-.69l1.174-3.616z" />
                                </svg>
                            </button>
